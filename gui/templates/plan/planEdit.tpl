...
{include file="inc_update.tpl" user_feedback=$gui->user_feedback}
  ...
  <table class="common" width="80%">
    ...
    <tr><th style="background:none;">脚本流</th>
        <td><select name="testplan_script_tag">
  			<option value ='newest' {if $gui->testplan_script_tag=='newest'} selected='selected'{/if} >Newest</option>
			<option value ='7.2' {if $gui->testplan_script_tag=='7.2'} selected='selected'{/if} >7.2</option>
			<option value ='7.0patch' {if $gui->testplan_script_tag=='7.0patch'} selected='selected'{/if} >7.0patch</option>
			<option value ='6.3' {if $gui->testplan_script_tag=='6.3'} selected='selected'{/if} >6.3</option>
			<option value ='aftersale' {if $gui->testplan_script_tag=='aftersale'} selected='selected'{/if} >AfterSale</option>
			</select>
		</td>
    </tr>
