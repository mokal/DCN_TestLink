...
{* ----- load javascripts libraries -------------------------------------------------- *} 
	...
	<script type="text/javascript" src="{$basehref}third_party/lib/js/json2.js"></script>
	<script type="text/javascript" src="{$basehref}third_party/jquery/jquery-2.0.3.min.js"></script>
