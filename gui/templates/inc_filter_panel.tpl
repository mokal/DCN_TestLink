    ...
    <div id="settings" class="x-panel-body" style="padding-top: 3px;overflow: visible;">
      ...
      {if $control->settings.setting_testplan}
        <tr>
          ...
          <td>
            <select class="chosen-select" name="setting_testplan" id="now_selected_tplan" onchange="this.form.submit()">
      ...
      {if $control->settings.setting_platform}
        ...
        <tr>
          ...
          <td>
            <select name="setting_platform" class="chosen-select" id="now_selected_device" onchange="this.form.submit()">
      ...
      {if $control->settings.setting_build}
        <tr>
          ...
          <td>
            <select name="setting_build" class="chosen-select" id= "now_selected_build" onchange="this.form.submit()">
      ...
      {/if}
      {if $control->settings.setting_platform}
       <tr><td>执行测试</td><td style="cursor:pointer"><image src="./gui/themes/default/images/runtc.png" title="自动执行测试" onclick="run_plan_device_build();" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
       <image src="./gui/themes/default/images/runcloud.jpg" title="云端自动执行测试" onclick="run_plan_device_build_cloud();" /></td></tr>
      {/if}
      </table>
    </div> {* settings *}
  </div> {* settings_panel *}
