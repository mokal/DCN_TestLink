...
<script>
function run_plan_device_build(){
  var tplan =  document.getElementById("now_selected_tplan").options[document.getElementById("now_selected_tplan").options.selectedIndex].value;
  var device = document.getElementById("now_selected_device").options[document.getElementById("now_selected_device").options.selectedIndex].value;
  var build = document.getElementById("now_selected_build").options[document.getElementById("now_selected_build").options.selectedIndex].value;

  window.open("/lib/execute/dcnExecution.php?productline={$session.testprojectID}&tplan="+tplan+"&device="+device+"&build="+build,"workframe");
}

function run_plan_device_build_cloud(){
  var tplan =  document.getElementById("now_selected_tplan").options[document.getElementById("now_selected_tplan").options.selectedIndex].value;
  var device = document.getElementById("now_selected_device").options[document.getElementById("now_selected_device").options.selectedIndex].value;
  var build = document.getElementById("now_selected_build").options[document.getElementById("now_selected_build").options.selectedIndex].value;
  window.open("/lib/execute/dcnCloudExecution.php?productline={$session.testprojectID}&tplan="+tplan+"&device="+device+"&build="+build,"workframe");
}
