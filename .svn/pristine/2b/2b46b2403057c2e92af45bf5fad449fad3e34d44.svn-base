 ...
 */
$tlCfg->log_path = '/wwwdata/testlink/logs/'; /* unix example */
 ...
 */
$g_loggerCfg = array('file' => array('enable' => true));
...
# Configure using custom_config.inc.php
$g_tl_admin_email     = 'admin@localhost.localdomain'; # for problem/error notification
$g_from_email         = 'admin@localhost.localdomain';  # email sender
$g_return_path_email  = 'admin@localhost.localdomain';
...
$tlCfg->login_info = "<span style='color:#E53333;'>WARNING：登陆后请谨慎进行删除及修改操作！"; // Empty by default
...
$tlCfg->gui->op_area_display->test_case = 'inlile'; // 'none'
$tlCfg->gui->op_area_display->req_spec_container = 'inline'; // 'none'
$tlCfg->gui->op_area_display->req = 'inline'; // 'none'
...
$tlCfg->gui->text_editor['steps_design'] = array('type' => 'none');
...
$tlCfg->resultMatrixReport->buildColumns['showStatusLastExecuted'] = false;
 ...
 */
$tlCfg->document_generator->company_name = '神州数码网络(北京)有限公司';
$tlCfg->document_generator->company_copyright = '2014 &copy; DCN Networks Co., Ltd.';
$tlCfg->document_generator->confidential_msg = '本文档的内容(包括但不限于文字、表格、数据、图像等)属神州数码网络(北京)有限公司知识产权，未经允许请勿外泄！';
...
$tlCfg->spec_cfg->show_tsuite_filter = DISABLED;
 ...
 *
 **/
$g_repositoryPath = '/wwwdata/testlink/upload_area/';  /* unix example */
...
$tlCfg->repository_max_filesize = 25; //MB
...
$tlCfg->tree_filter_cfg->testcases->execution_mode->filter_tc_id = DISABLED;
...
$tlCfg->tree_filter_cfg->testcases->execution_mode->filter_bugs = DISABLED;
$tlCfg->tree_filter_cfg->testcases->execution_mode->advanced_filter_mode_choice = DISABLED;

$tlCfg->tree_filter_cfg->testcases->edit_mode->filter_tc_id = DISABLED;
...
$tlCfg->tree_filter_cfg->testcases->plan_mode->filter_tc_id = DISABLED;
...
$tlCfg->tree_filter_cfg->testcases->plan_mode->advanced_filter_mode_choice = DISABLED;

$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_tc_id = DISABLED;
...
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_workflow_status = DISABLED;
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->filter_custom_fields = ENABLED;
$tlCfg->tree_filter_cfg->testcases->plan_add_mode->advanced_filter_mode_choice = DISABLED;

$tlCfg->tree_filter_cfg->requirements->filter_doc_id = DISABLED;
...
$tlCfg->tree_filter_cfg->requirements->advanced_filter_mode_choice = DISABLED;
...
$tlCfg->import_file_max_size_bytes = '26214400';

/** Maximum line size of the imported file */
$tlCfg->import_max_row = '100000000'; // in chars
...
// 0 => do not check.
$tlCfg->custom_fields->max_length = 0;
...
$tlCfg->custom_fields->sizes = array('string' => 100,
                                     ...
                                     'email' => 100,
                                     'list' => 50,
                                     'multiselection list' => 50,
                         'text area' => array('rows' => 20, 'cols' => 80),
                       'script' => 100,
                       'server' => 100);
 ...
 **/
$tlCfg->action_on_duplicate_name = 'block';
