...
function renderFirstPage($doc_info)
{
  ...
  //add by guomf to custom report function
  switch($doc_info->testresult){
  case "通过":
      $output .= '<br>测试结论: ' . "<span style='color:#006600;'>" . $doc_info->testresult . "</span>"; 
      break;
  case "不通过":
      $output .= '<br>测试结论: ' . "<span style='color:#E53333;'>" . $doc_info->testresult . "</span>"; 
      break;
  case "检验后通过":
      $output .= '<br>测试结论: ' . "<span style='color:#00D5FF;'>" . $doc_info->testresult . "</span>"; 
      break;
  default:
      $output .= '<br>测试结论: ' . "<span style='color:#FF9900;'>" . $doc_info->testresult . "</span>"; 
      break;
  }
 // $output .= '<br>测试结论: ' . $doc_info->testresult;
  $output .= '<br>分析与总结: <br>';
  $output .=  "<span style='font-size:16px;'>" . nl2br($doc_info->resultsummary) . "</span>";
