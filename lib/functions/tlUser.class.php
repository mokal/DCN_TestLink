...
//add by guomf for dcnIssue
  public function getIssue(&$db)
  {
    $sql = " SELECT *".
           " FROM dcnIssue ";

    $issueSet = $db->exec_query($sql);
  ...
  function getAccessibleTestPlans(&$db,$testprojectID,$testplanID=null, $options=null)
  {
    ...
    $fields2get = ' NH.id, NH.name, TPLAN.is_public, COALESCE(USER_TPLAN_ROLES.testplan_id,0) AS has_role, ' .
                  ' USER_TPLAN_ROLES.role_id AS user_testplan_role, TPLAN.active, TPLAN.script_tag, 0 AS selected ';
