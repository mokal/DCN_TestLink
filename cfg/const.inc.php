...
$tlCfg->results['charts']['status_colour'] = array('not_run' => '000000','passed'  => '006400',
                           'failed'  => 'B22222','olddiff'  => 'B22222','blocked' => '00008B');
...
$tlCfg->guiTopMenu[4] = array('label' => 'title_testplan','url' => 'lib/plan/planView.php',
                              'right' => null,'condition'=>'','shortcut'=>'i','target'=>'mainframe'); 

$tlCfg->guiTopMenu[5] = array('label' => 'title_dcnvars','url' => 'lib/dcnVars/viewVar.php',
		'right' => null,'condition'=>'','shortcut'=>'i','target'=>'mainframe');

$tlCfg->guiTopMenu[6] = array('label' => 'title_execute',
